...
(function($){
    ...
    var pageName = location.pathname.split(/(\\|\/)/g).pop(); // returns index.php or about-us.php
    // alert(pageName);
    ...
    else if (pageName == "about-us.php"){
        $('.menu li:nth-child(2) a').addClass("current");
    }
    else if (pageName == "register-cv.php"){
        $('.menu li:nth-child(3) a').addClass("current");
    }
    else if (pageName == "search-job.php"){
        $('.menu li:nth-child(4) a').addClass("current");
    }
    else if (pageName == "recruit-today.php"){
        $('.menu li:nth-child(5) a').addClass("current");
    }
    else if (pageName == "contact.php"){
        $('.menu li:nth-child(6) a').addClass("current");
    }
